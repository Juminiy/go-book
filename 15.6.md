...
为了在可执行程序之外维护 wiki 页面内容，我们简单地使用了文本文件作为持久化存储。程序、必要的模板和文本文件可以在 [wiki](examples/chapter\_15/wiki/) 中找到。

示例 15.12 [wiki.go](examples/chapter\_15/wiki/wiki.go)
